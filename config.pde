...
// starting node index
final int START = 2244;

// tweakable values
final int   MAZE_SEED     = 42;    // seed for random functions
final float DISTANCE_COST = -0.01; // cost of moving to a neighbor at the same altitude
final float HILL_COST     = 1.0;   // scaling factor for cost of altitude difference
